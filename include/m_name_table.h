...
#define MONEY_NUM 4
#define TOOL_NUM 92
#define FISH_NUM 80 /* 40 vanilla + modded fish (see fish/ADDING_FISH.md) */
...
/* one-past-the-last fish, mirrors the vanilla (+40 for 40 fish) convention;
 * scales with modded fish automatically */
#define ITM_FISH_END (ITM_FISH_START + FISH_NUM)
