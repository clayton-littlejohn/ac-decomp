...
enum fish_type {
    ...
    aGYO_TYPE_PIKE,
    aGYO_TYPE_YELLOW_PERCH,
    aGYO_TYPE_STURGEON,
    aGYO_TYPE_GOLDEN_TROUT,
    aGYO_TYPE_TILAPIA,
    aGYO_TYPE_BETTA,
    aGYO_TYPE_RAINBOWFISH,
    aGYO_TYPE_GAR,
    aGYO_TYPE_DORADO,
    aGYO_TYPE_SADDLED_BICHIR,
    aGYO_TYPE_NIBBLE_FISH,
    aGYO_TYPE_TADPOLE,
    aGYO_TYPE_SNAPPING_TURTLE,
    aGYO_TYPE_SOFTSHELL_TURTLE,
    aGYO_TYPE_MITTEN_CRAB,
    aGYO_TYPE_TUNA,
    aGYO_TYPE_BLUE_MARLIN,
    aGYO_TYPE_OCEAN_SUNFISH,
    aGYO_TYPE_RAY,
    aGYO_TYPE_SAW_SHARK,
    aGYO_TYPE_HAMMERHEAD_SHARK,
    aGYO_TYPE_GREAT_WHITE_SHARK,
    aGYO_TYPE_WHALE_SHARK,
    aGYO_TYPE_NAPOLEONFISH,
    aGYO_TYPE_BARRELEYE,
    aGYO_TYPE_MAHI_MAHI,
    aGYO_TYPE_RIBBON_EEL,
    aGYO_TYPE_MORAY_EEL,
    aGYO_TYPE_SEAHORSE,
    aGYO_TYPE_CLOWNFISH,
    aGYO_TYPE_SURGEONFISH,
    aGYO_TYPE_BUTTERFLY_FISH,
    aGYO_TYPE_ZEBRA_TURKEYFISH,
    aGYO_TYPE_PUFFER_FISH,
    aGYO_TYPE_HORSE_MACKEREL,
    aGYO_TYPE_SQUID,
    aGYO_TYPE_ANCHOVY,
    aGYO_TYPE_FOOTBALL_FISH,
    aGYO_TYPE_OLIVE_FLOUNDER,
