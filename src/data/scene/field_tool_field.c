...
extern Scene_Word_u field_tool_field_info[] = {
    ...
    mSc_DATA_FIELDCT(mSc_ITEM_TYPE_BGITEM, 9, 0x2800, mSc_ROOM_TYPE_OUTDOORS,
                     FIELD_DRAW_TYPE_OUTDOORS), // Field construct params @MOD seamless acres: 9 visible acres (vanilla 4)
